                ...
                <c:forEach items="${pcList}" var="pc1">
                    <li>
                        ...
                        <c:forEach items="${pc1.productCategoryVoList}" var="pc2">
                                <div class="zj_l_c">
                                    <h2><a href="${ctx}/Product?action=queryProductList&categoryId=${pc3.productCategory.id}">${pc2.productCategory.name}</a></h2>
...
<script type="text/javascript" scr="${ctx}/statics/js/common/n_nav.js"></script>
</body>
