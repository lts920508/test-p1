...
<title>易买网</title>
  ...
  <body>
	...
	<div class="sou">
        ...
        <c:if test="${sessionScope.loginUser!=null && sessionScope.loginUser.type==0}">
        	<span class="fl">${sessionScope.loginUser.userName}&nbsp;|&nbsp; <a href="${ctx}/admin/order?action=index&userId=${sessionScope.loginUser.id}" style="color:#ff4e00;">我的订单</a>&nbsp;</span>
        </c:if>
        <c:if test="${sessionScope.loginUser!=null && sessionScope.loginUser.type==1}">
        	<span class="fl">${sessionScope.loginUser.userName}&nbsp;|&nbsp; <a href="${ctx}/admin/order?action=index&userId=${sessionScope.loginUser.id}" style="color:#ff4e00;">后台管理</a>&nbsp;</span>
        </c:if>
        <c:if test="${sessionScope.loginUser!=null}">
