		...
		<div class="m_right">
            ...
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
              	<td width="95">&nbsp;</td>
                <td>
                	<span class="fl" style="font-size:24px;">新增用户</span>
                </td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <input type="radio" name="sex" value="0" />&nbsp;女&nbsp;&nbsp;&nbsp;(谨慎选择，无法修改！)
                </td>
              </tr>
              <tr height="50">
              ...
              <tr height="60">
              	<td>&nbsp;</td>
                <td><input type="button" value="添加用户" class="log_btn" onclick="register('xinzeng');"/></td>
              </tr>
            </table>
            </form>
    </div>
