...
<%@include file="/common/backend/leftBar.jsp" %>
		<div class="m_right">
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              ...
              <c:forEach items="${allOrderList}" var="temp">
              <tr>
             ...
             <div class="pages">
                	<a href="${ctx}/admin/order?action=queryAllOrder&currentPage=${pager.currentPage-1}" class="p_pre">上一页</a><c:forEach begin="1" end="${pager.pageCount}" var="i" step="1"><a href="${ctx}/admin/order?action=queryAllOrder&currentPage=${i}"  <c:if test="${pager.currentPage==i}">class="cur"</c:if> >${i}</a></c:forEach><a href="${ctx}/admin/order?action=queryAllOrder&currentPage=${pager.currentPage+1}" class="p_pre">下一页</a>
                </div>
        </div>
    </div>
	<!--End 用户中心 End--> 
